...
namespace portaBLe.Refresh
{
    public class RatingsRefresh
    {
        ...
        public static async Task Overwrite(AppContext dbContext)
        {
            ...
            await Parallel.ForEachAsync(lbs, parallelOptions, async (lb, ct) =>
            {
                try
                {
                    ...
                    lb.ModifiersRating.SSStaminaRating = (float)response["SS"].LackMapCalculation.StaminaRating;
                    ...
                    lb.ModifiersRating.FSStaminaRating = (float)response["FS"].LackMapCalculation.StaminaRating;
                    ...
                    lb.ModifiersRating.SFStaminaRating = (float)response["SFS"].LackMapCalculation.StaminaRating;

                    lb.ModifiersRating.SFStars = ReplayUtils.ToStars(lb.ModifiersRating.SFAccRating, lb.ModifiersRating.SFPassRating, lb.ModifiersRating.SFTechRating, lb.ModifiersRating.SFStaminaRating);
                    lb.ModifiersRating.FSStars = ReplayUtils.ToStars(lb.ModifiersRating.FSAccRating, lb.ModifiersRating.FSPassRating, lb.ModifiersRating.FSTechRating, lb.ModifiersRating.FSStaminaRating);
                    lb.ModifiersRating.SSStars = ReplayUtils.ToStars(lb.ModifiersRating.SSAccRating, lb.ModifiersRating.SSPassRating, lb.ModifiersRating.SSTechRating, lb.ModifiersRating.SFStaminaRating);
        ...
        public static async Task OverwriteStamina(AppContext dbContext)
        {
            ...
            await Parallel.ForEachAsync(lbs, parallelOptions, async (lb, ct) =>
            {
                try
                {
                    ...
                    var response = controller.GetStamina(lb.Hash, lb.ModeName, GetDiffCode(lb.DifficultyName)).Value;
        ...
        public static async Task Refresh(AppContext dbContext)
        {
            ...
            foreach (var lb in lbs)
            {
                try
                {
                    ...
                    lb.ModifiersRating.SFStars = ReplayUtils.ToStars(lb.ModifiersRating.SFAccRating, lb.ModifiersRating.SFPassRating, lb.ModifiersRating.SFTechRating, lb.ModifiersRating.SFStaminaRating);
                    lb.ModifiersRating.FSStars = ReplayUtils.ToStars(lb.ModifiersRating.FSAccRating, lb.ModifiersRating.FSPassRating, lb.ModifiersRating.FSTechRating, lb.ModifiersRating.FSStaminaRating);
                    lb.ModifiersRating.SSStars = ReplayUtils.ToStars(lb.ModifiersRating.SSAccRating, lb.ModifiersRating.SSPassRating, lb.ModifiersRating.SSTechRating, lb.ModifiersRating.SSStaminaRating);
                }
                catch (Exception e)
                {
