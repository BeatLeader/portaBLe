    ...
    public class LeaderboardStatsModel : BasePageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string searchString, string modeName, string sortBy = "Megametric125", bool? sortDescending = true, int currentPage = 1, string db = null)
        {
            ...
            query = SortBy switch
            {
                ...
                "MultiPercentage" => SortDescending ? query.OrderByDescending(x => x.MultiPercentage) : query.OrderBy(x => x.MultiPercentage),
                ...
                "StaminaRating" => SortDescending ? query.OrderByDescending(x => x.StaminaRating) : query.OrderBy(x => x.StaminaRating),
