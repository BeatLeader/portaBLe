...
namespace portaBLe
{
    public class PlayersRefresh
    {
        ...
        public static async Task Refresh(AppContext dbContext) {
            ...
            await dbContext.BulkUpdateAsync(playerUpdates, options => options.ColumnInputExpression = c => new { c.Rank, c.Pp, c.TopPp, c.RankedPlayCount, c.CountryRank, c.AccPp, c.TechPp, c.PassPp });
        }
    }
